...
class StoreSubscriptionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'billing_cycle' => ['required', 'string', 'in:monthly,yearly,weekly,custom'],
            ...
            'price_history.*.price' => ['required_with:price_history', 'numeric', 'min:1', 'max:999999'],
    ...
    public function messages(): array
    {
        return [
            ...
            'category.required' => 'Please select a category for this subscription.',
            'cost.required' => 'The subscription cost is required.',
            'cost.numeric' => 'The cost must be a valid number.',
            'cost.min' => 'The cost cannot be negative.',
            'cost.max' => 'The cost cannot exceed 999,999.',
            ...
            'next_billing_date.required' => 'The next billing date is required.',
