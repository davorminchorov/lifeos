...
@section('title', 'Create Invoice - Invoicing')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">Create Invoice</h1>
                <p class="text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)] mt-2">Create a new invoice draft</p>
            </div>
        ...
        <div class="bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] shadow-md rounded-lg border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)]">
            <form method="POST" action="{{ route('invoicing.invoices.store') }}" class="space-y-6 p-6">
                @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="relative">
                                    <input type="radio" name="tax_behavior" id="tax_exclusive" value="exclusive" {{ old('tax_behavior', 'exclusive') === 'exclusive' ? 'checked' : '' }} required class="peer sr-only">
                                ...
                                <div class="relative">
                                    <input type="radio" name="tax_behavior" id="tax_inclusive" value="inclusive" {{ old('tax_behavior') === 'inclusive' ? 'checked' : '' }} required class="peer sr-only">
                        ...
                        <div>
                            <x-form.input type="number" name="net_terms_days" label="Payment Terms (Days)"
                                :value="old('net_terms_days', config('invoicing.net_terms_days', 14))"
                                min="0" max="365"
            ...
            <div class="flex">
                ...
                <div class="ml-3 flex-1">
                    <p class="text-sm text-blue-700 dark:text-blue-300">
                        After creating the draft, you'll be able to add line items, apply taxes and discounts, and then issue the invoice to the customer.
                    </p>
                </div>
            </div>
        </div>
