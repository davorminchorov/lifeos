...
@section('title', 'Create Tax Rate - Invoicing')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">Create Tax Rate</h1>
                <p class="text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)] mt-2">Create a new tax rate for invoices</p>
            </div>
        ...
        <div class="bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] shadow-md rounded-lg border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)]">
            <form method="POST" action="{{ route('invoicing.tax-rates.store') }}" class="space-y-6 p-6">
                @csrf
            ...
            <div class="flex">
                ...
                <div class="ml-3 flex-1">
                    <p class="text-sm text-blue-700 dark:text-blue-300">
                        Tax rates are expressed in basis points. 100 basis points = 1%. For example, enter 2000 for a 20% tax rate.
                    </p>
                </div>
            </div>
        </div>
