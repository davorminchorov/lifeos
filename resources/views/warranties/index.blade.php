...
@section('header')
    <div class="flex justify-between items-center">
        ...
        <a href="{{ route('warranties.create') }}" class="bg-[color:var(--color-accent-600)] hover:bg-[color:var(--color-accent-700)] text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 shadow-sm">
            Add Warranty
        </a>
    </div>
@endsection
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('warranties.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-[color:var(--color-accent-600)] hover:bg-[color:var(--color-accent-700)]">
                            Add Warranty
                        </a>
                    </div>
                </div>
