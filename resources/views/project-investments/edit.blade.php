...
@section('title', 'Edit ' . $projectInvestment->name . ' - Project Investments - LifeOS')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">Edit Project Investment</h1>
                <p class="text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)] mt-2">Update {{ $projectInvestment->name }}</p>
            </div>
        ...
        <div class="bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] shadow-md rounded-lg border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)]">
            <form method="POST" action="{{ route('project-investments.update', $projectInvestment) }}" class="space-y-6 p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" required
                               value="{{ old('name', $projectInvestment->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="project_type" id="project_type"
                               value="{{ old('project_type', $projectInvestment->project_type) }}"
                               class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]"
                    ...
                    <div>
                        ...
                        <select name="stage" id="stage"
                            ...
                            <option value="idea" {{ old('stage', $projectInvestment->stage) === 'idea' ? 'selected' : '' }}>Idea</option>
                            <option value="prototype" {{ old('stage', $projectInvestment->stage) === 'prototype' ? 'selected' : '' }}>Prototype</option>
                            <option value="mvp" {{ old('stage', $projectInvestment->stage) === 'mvp' ? 'selected' : '' }}>MVP</option>
                            <option value="growth" {{ old('stage', $projectInvestment->stage) === 'growth' ? 'selected' : '' }}>Growth</option>
                            <option value="mature" {{ old('stage', $projectInvestment->stage) === 'mature' ? 'selected' : '' }}>Mature</option>
                        </select>
                        @error('stage')
                            <p class="mt-1 text-sm text-[color:var(--color-danger-600)] dark:text-[color:var(--color-danger-400)]">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="business_model" id="business_model"
                            ...
                            <option value="subscription" {{ old('business_model', $projectInvestment->business_model) === 'subscription' ? 'selected' : '' }}>Subscription</option>
                            <option value="ads" {{ old('business_model', $projectInvestment->business_model) === 'ads' ? 'selected' : '' }}>Advertising</option>
                            <option value="one-time" {{ old('business_model', $projectInvestment->business_model) === 'one-time' ? 'selected' : '' }}>One-time Purchase</option>
                            <option value="freemium" {{ old('business_model', $projectInvestment->business_model) === 'freemium' ? 'selected' : '' }}>Freemium</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="status" id="status"
                                class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">
                            <option value="active" {{ old('status', $projectInvestment->status) === 'active' ? 'selected' : '' }}>Active</option>
                            <option value="completed" {{ old('status', $projectInvestment->status) === 'completed' ? 'selected' : '' }}>Completed</option>
                            <option value="sold" {{ old('status', $projectInvestment->status) === 'sold' ? 'selected' : '' }}>Sold</option>
                            <option value="abandoned" {{ old('status', $projectInvestment->status) === 'abandoned' ? 'selected' : '' }}>Abandoned</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-[color:var(--color-danger-600)] dark:text-[color:var(--color-danger-400)]">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="number" step="0.01" name="equity_percentage" id="equity_percentage" min="0" max="100"
                                   value="{{ old('equity_percentage', $projectInvestment->equity_percentage) }}"
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input type="number" step="0.01" name="current_value" id="current_value" min="0"
                                       value="{{ old('current_value', $projectInvestment->current_value) }}"
                                       class="block w-full pl-7 pr-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="url" name="website_url" id="website_url"
                                   value="{{ old('website_url', $projectInvestment->website_url) }}"
                                   class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]"
                        ...
                        <div>
                            ...
                            <input type="url" name="repository_url" id="repository_url"
                                   value="{{ old('repository_url', $projectInvestment->repository_url) }}"
                                   class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" name="start_date" id="start_date"
                                   value="{{ old('start_date', $projectInvestment->start_date?->format('Y-m-d')) }}"
                                   class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">
                            @error('start_date')
                                <p class="mt-1 text-sm text-[color:var(--color-danger-600)] dark:text-[color:var(--color-danger-400)]">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="date" name="end_date" id="end_date"
                                   value="{{ old('end_date', $projectInvestment->end_date?->format('Y-m-d')) }}"
                                   class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">
                            @error('end_date')
                                <p class="mt-1 text-sm text-[color:var(--color-danger-600)] dark:text-[color:var(--color-danger-400)]">{{ $message }}</p>
                            @enderror
                ...
                <div class="border-t border-[color:var(--color-primary-200)] dark:border-[color:var(--color-dark-300)] pt-6">
                    ...
                    <div>
                        ...
                        <textarea name="notes" id="notes" rows="4"
                                  class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]"
                                  placeholder="Key milestones, KPIs, roadmap, team information, etc.">{{ old('notes', $projectInvestment->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-[color:var(--color-danger-600)] dark:text-[color:var(--color-danger-400)]">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="border-t border-[color:var(--color-primary-200)] dark:border-[color:var(--color-dark-300)] pt-6">
                    <div class="flex justify-end space-x-3">
                        <x-button href="{{ route('project-investments.show', $projectInvestment) }}" variant="secondary">Cancel</x-button>
                        <x-button type="submit" variant="primary">Update Project Investment</x-button>
                    </div>
                </div>
            </form>
        </div>
