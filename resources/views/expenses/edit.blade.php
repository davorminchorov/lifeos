...
@section('header')
    <div class="flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('expenses.show', $expense) }}" class="bg-[color:var(--color-primary-500)] hover:bg-[color:var(--color-primary-600)] text-white px-4 py-2 rounded-md text-sm font-medium">
                View Expense
            </a>
            ...
            <form method="POST" action="{{ route('expenses.update', $expense) }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        @error('amount')
                            <p class="mt-1 text-sm text-[color:var(--color-danger-500)]">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="currency" id="currency" required class="mt-1 block w-full rounded-md border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] dark:bg-[color:var(--color-dark-100)] dark:text-[color:var(--color-dark-600)] shadow-sm focus:border-[color:var(--color-accent-500)] focus:ring-[color:var(--color-accent-500)]">
                    ...
                    <div>
                        ...
                        <select name="category" id="category" required class="mt-1 block w-full rounded-md border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] dark:bg-[color:var(--color-dark-100)] dark:text-[color:var(--color-dark-600)] shadow-sm focus:border-[color:var(--color-accent-500)] focus:ring-[color:var(--color-accent-500)]">
                    ...
                    <!-- Subcategory -->
                    <div>
                        <label for="subcategory" class="block text-sm font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">Subcategory</label>
                    ...
                    <div>
                        ...
                        <select name="payment_method" id="payment_method" class="mt-1 block w-full rounded-md border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] dark:bg-[color:var(--color-dark-100)] dark:text-[color:var(--color-dark-600)] shadow-sm focus:border-[color:var(--color-accent-500)] focus:ring-[color:var(--color-accent-500)]">
                ...
                <div>
                    ...
                    <input type="text" name="tags" id="tags" value="{{ old('tags', is_array($expense->tags) ? implode(', ', $expense->tags) : $expense->tags) }}" placeholder="Comma-separated tags"
                           class="mt-1 block w-full rounded-md border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] dark:bg-[color:var(--color-dark-100)] dark:text-[color:var(--color-dark-600)] shadow-sm focus:border-[color:var(--color-accent-500)] focus:ring-[color:var(--color-accent-500)]">
                    <p class="mt-1 text-sm text-[color:var(--color-primary-500)] dark:text-[color:var(--color-dark-500)]">Separate multiple tags with commas</p>
                    @error('tags')
                        <p class="mt-1 text-sm text-[color:var(--color-danger-500)]">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="3"
                              class="mt-1 block w-full rounded-md border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] dark:bg-[color:var(--color-dark-100)] dark:text-[color:var(--color-dark-600)] shadow-sm focus:border-[color:var(--color-accent-500)] focus:ring-[color:var(--color-accent-500)]">{{ old('notes', $expense->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-[color:var(--color-danger-500)]">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <!-- Budget Allocated -->
                <div>
                    <label for="budget_allocated" class="block text-sm font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">Budget Allocated</label>
                    <input type="number" name="budget_allocated" id="budget_allocated" step="0.01" min="0" value="{{ old('budget_allocated', $expense->budget_allocated) }}"
                           class="mt-1 block w-full rounded-md border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] dark:bg-[color:var(--color-dark-100)] dark:text-[color:var(--color-dark-600)] shadow-sm focus:border-[color:var(--color-accent-500)] focus:ring-[color:var(--color-accent-500)]">
                    <p class="mt-1 text-sm text-[color:var(--color-primary-500)] dark:text-[color:var(--color-dark-500)]">Optional budget amount for this expense</p>
                ...
                <div id="recurring-schedule" class="{{ $expense->is_recurring ? '' : 'hidden' }}">
                    <label for="recurring_schedule" class="block text-sm font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)]">Recurring Schedule</label>
                    <select name="recurring_schedule" id="recurring_schedule" class="mt-1 block w-full rounded-md border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] dark:bg-[color:var(--color-dark-100)] dark:text-[color:var(--color-dark-600)] shadow-sm focus:border-[color:var(--color-accent-500)] focus:ring-[color:var(--color-accent-500)]">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('expenses.show', $expense) }}" class="bg-[color:var(--color-primary-200)] hover:bg-[color:var(--color-primary-300)] text-[color:var(--color-primary-700)] dark:bg-[color:var(--color-dark-300)] dark:hover:bg-[color:var(--color-dark-400)] dark:text-[color:var(--color-dark-600)] px-4 py-2 rounded-md text-sm font-medium">
                        Cancel
                    </a>
