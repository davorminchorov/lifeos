...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add Utility Bill</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Add a new utility bill to track your usage and payments</p>
            </div>
