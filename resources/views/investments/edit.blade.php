...
@section('header')
    <div class="flex items-center justify-between mb-8">
        ...
        <x-button href="{{ route('investments.index') }}" variant="secondary">
        ...
        <form method="POST" action="{{ route('investments.update', $investment) }}" class="space-y-6 p-6">
            ...
            <x-form.section title="Investment Goals" description="Select your investment objectives for this position.">
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-[color:var(--color-primary-500)] dark:text-[color:var(--color-dark-500)]">Select all that apply to this investment.</p>
                    <fieldset class="mt-4">
            ...
            <div class="border-t border-[color:var(--color-primary-200)] dark:border-[color:var(--color-dark-300)] pt-6">
                <div class="flex justify-end space-x-3">
                    ...
                    <x-button type="submit" variant="primary">Update Investment</x-button>
                </div>
            </div>
        </form>
        </div>
