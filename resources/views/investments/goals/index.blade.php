                        ...
                        @foreach($goals as $goal)
                            <div class="bg-[color:var(--color-primary-50)] dark:bg-[color:var(--color-dark-100)] rounded-lg p-6">
                                ...
                                @if(isset($goal['description']))
                                    <p class="text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)] text-sm mb-4">{{ $goal['description'] }}</p>
                                @endif

                                <div class="space-y-3">
                                    <div class="flex justify-between">
                                        <span class="text-sm text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)]">Target Amount</span>
                                        <span class="font-medium">${{ number_format($goal['target_amount'] ?? 0, 2) }}</span>
                                    </div>

                                    <div class="flex justify-between">
                                        <span class="text-sm text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)]">Current Progress</span>
                                        <span class="font-medium">${{ number_format($goal['current_progress'] ?? 0, 2) }}</span>
                                    </div>

                                    @if(isset($goal['target_date']))
                                        <div class="flex justify-between">
                                            <span class="text-sm text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)]">Target Date</span>
