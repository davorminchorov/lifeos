            ...
            <div class="p-6 text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] dark:text-[color:var(--color-primary-100)] dark:text-[color:var(--color-dark-200)]">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-3">
                        <x-button href="{{ route('investments.index') }}" variant="secondary">← Back to Investments</x-button>
                        <x-button type="button" variant="primary" onclick="generateRebalancingRecommendations()">
                ...
                @if(count($alerts) > 0)
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div class="bg-[color:var(--color-warning-50)] dark:bg-[color:var(--color-warning-900)]/20 rounded-lg p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <svg class="h-8 w-8 text-[color:var(--color-warning-600)] dark:text-[color:var(--color-warning-400)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                                    </svg>
                                </div>
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-2xl font-bold text-[color:var(--color-warning-600)] dark:text-[color:var(--color-warning-400)]">{{ $mediumAlerts }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-2xl font-bold text-[color:var(--color-info-600)] dark:text-blue-400">{{ $lowAlerts }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        @foreach($alerts as $alert)
                            <div class="border-l-4 {{ $alert['severity'] === 'high' ? 'border-[color:var(--color-danger-500)] bg-red-50 dark:bg-red-900/20' : ($alert['severity'] === 'medium' ? 'border-yellow-500 bg-[color:var(--color-warning-50)] dark:bg-[color:var(--color-warning-900)]/20' : 'border-blue-500 bg-[color:var(--color-info-50)] dark:bg-[color:var(--color-info-900)]/20') }} p-6 rounded-r-lg">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4 flex-1">
                                        <div class="flex items-center justify-between mb-2">
                                            <h3 class="text-lg font-medium {{ $alert['severity'] === 'high' ? 'text-[color:var(--color-danger-600)] dark:text-[color:var(--color-danger-200)]' : ($alert['severity'] === 'medium' ? 'text-[color:var(--color-warning-600)] dark:text-[color:var(--color-warning-200)]' : 'text-[color:var(--color-info-600)] dark:text-[color:var(--color-info-200)]') }}">
                                        ...
                                        <p class="text-sm {{ $alert['severity'] === 'high' ? 'text-[color:var(--color-danger-700)] dark:text-[color:var(--color-danger-300)]' : ($alert['severity'] === 'medium' ? 'text-[color:var(--color-warning-700)] dark:text-[color:var(--color-warning-300)]' : 'text-[color:var(--color-info-700)] dark:text-[color:var(--color-info-300)]') }} mb-3">
                                            {{ $alert['message'] }}
                                        </p>
                                        <div class="bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)] rounded-lg p-4 border {{ $alert['severity'] === 'high' ? 'border-red-200 dark:border-red-700' : ($alert['severity'] === 'medium' ? 'border-yellow-200 dark:border-yellow-700' : 'border-blue-200 dark:border-blue-700') }}">
                                            <h4 class="text-sm font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] dark:text-[color:var(--color-primary-100)] dark:text-[color:var(--color-dark-200)] mb-2">Recommendation:</h4>
                ...
                @else
                    ...
                    <div class="text-center py-16">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] dark:text-[color:var(--color-primary-100)] dark:text-[color:var(--color-dark-200)]">All Clear!</h3>
                ...
                <div class="mt-12 bg-[color:var(--color-primary-50)] dark:bg-[color:var(--color-dark-100)] rounded-lg p-6">
                    <h3 class="text-lg font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] dark:text-[color:var(--color-primary-100)] dark:text-[color:var(--color-dark-200)] mb-4">Portfolio Rebalancing Guidelines</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <h4 class="text-sm font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] dark:text-[color:var(--color-primary-100)] dark:text-[color:var(--color-dark-200)] mb-2">When to Rebalance</h4>
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] dark:text-[color:var(--color-primary-100)] dark:text-[color:var(--color-dark-200)] mb-2">Best Practices</h4>
                            <ul class="text-sm text-[color:var(--color-primary-600)] dark:text-[color:var(--color-dark-500)] space-y-1">
...
<div id="recommendationsModal" class="hidden fixed inset-0 bg-[color:var(--color-primary-600)] bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-[color:var(--color-primary-100)] dark:bg-[color:var(--color-dark-200)]">
        <div class="mt-3">
            <h3 class="text-lg font-medium text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] dark:text-[color:var(--color-primary-100)] dark:text-[color:var(--color-dark-200)] mb-4">Target Allocation for Recommendations</h3>
            <form id="recommendationsForm" method="POST" action="{{ route('investments.rebalancing.recommendations') }}">
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4" id="allocationInputs">
                        <div>
                            ...
                            <input type="number" id="stocks_percentage" name="target_allocation[0][percentage]" min="0" max="100" step="0.1" value="60" class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] dark:bg-[color:var(--color-dark-300)] dark:text-white">
                        ...
                        <div>
                            ...
                            <input type="number" id="bonds_percentage" name="target_allocation[1][percentage]" min="0" max="100" step="0.1" value="30" class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] dark:bg-[color:var(--color-dark-300)] dark:text-white">
                        ...
                        <div>
                            ...
                            <input type="number" id="cash_percentage" name="target_allocation[2][percentage]" min="0" max="100" step="0.1" value="10" class="mt-1 block w-full px-3 py-2 border border-[color:var(--color-primary-300)] dark:border-[color:var(--color-dark-300)] rounded-md shadow-sm focus:outline-none focus:ring-[color:var(--color-accent-500)] focus:border-[color:var(--color-accent-500)] dark:bg-[color:var(--color-dark-300)] dark:text-white">
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closeRecommendationsModal()" class="px-4 py-2 bg-[color:var(--color-primary-300)] dark:bg-[color:var(--color-primary-600)] text-[color:var(--color-primary-700)] dark:text-[color:var(--color-dark-600)] rounded-md hover:bg-[color:var(--color-primary-400)] dark:hover:bg-[color:var(--color-primary-700)]">
                        Cancel
                    </button>
