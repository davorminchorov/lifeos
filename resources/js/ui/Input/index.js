...
const Input = React.forwardRef((_a, ref) => {
    var { className, type, variant = 'outlined', inputSize = 'md', error, helperText, label, fullWidth = true, id, value, placeholder, defaultValue, onChange } = _a, props = __rest(_a, ["className", "type", "variant", "inputSize", "error", "helperText", "label", "fullWidth", "id", "value", "placeholder", "defaultValue", "onChange"]);
    ...
    return (_jsxs("div", { className: containerStyles, children: [_jsxs("div", { className: "relative", children: [_jsx("input", Object.assign({ id: inputId, type: type, ref: ref, className: cn(baseStyles, sizeStyles[inputSize], variantStyles[variant], label ? 'pt-2' : '', className), placeholder: placeholder, onFocus: handleFocus, onBlur: handleBlur, onChange: handleChange, value: value, defaultValue: defaultValue }, props)), label && (_jsx("label", { htmlFor: inputId, className: labelStyles, style: {
