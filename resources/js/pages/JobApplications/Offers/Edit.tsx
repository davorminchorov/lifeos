...
export default function OfferEdit({ application, offer, statuses, currencies }: OfferEditProps) {
    ...
    function handleSubmit(e: FormEvent) {
        e.preventDefault()
        put(`/job-applications/${application.id}/offers/${offer.id}`)
    }

    return (
        <AppLayout>
            <Head title={`Edit Offer - ${application.company_name}`} />
            ...
            >
                <Button variant="outline" asChild>
                    <Link href={`/job-applications/${application.id}/offers/${offer.id}`}>Back to Offer</Link>
                </Button>
            </PageHeader>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="flex justify-end gap-3">
                            <Button type="button" variant="outline" asChild>
                                <Link href={`/job-applications/${application.id}/offers/${offer.id}`}>Cancel</Link>
                            </Button>
