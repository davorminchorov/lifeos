...
export default function BudgetCreate({ categories, currencies }: BudgetCreateProps) {
    ...
    return (
        <AppLayout>
            ...
            <PageHeader title="Create Budget" description="Set up a new spending budget">
                <Button variant="outline" asChild>
                    <Link href="/budgets">Back to List</Link>
                </Button>
            </PageHeader>
