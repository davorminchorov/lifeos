...
export default function TransactionCreate({ projectInvestment }: TransactionCreateProps) {
    ...
    function handleSubmit(e: FormEvent) {
        e.preventDefault()
        post(`/project-investments/${projectInvestment.id}/transactions`)
    }

    return (
        <AppLayout>
            <Head title={`Add Transaction - ${projectInvestment.name}`} />

            <PageHeader title="Add Transaction" description={`For ${projectInvestment.name}`}>
