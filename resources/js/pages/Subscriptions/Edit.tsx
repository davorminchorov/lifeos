...
export default function SubscriptionEdit({ subscription }: SubscriptionEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        billing_cycle_days: subscription.billing_cycle_days ? String(subscription.billing_cycle_days) : '',
        start_date: subscription.start_date,
        next_billing_date: subscription.next_billing_date ?? '',
        payment_method: subscription.payment_method ?? '',
        merchant_info: subscription.merchant_info ?? '',
        auto_renewal: subscription.auto_renewal,
        cancellation_difficulty: subscription.cancellation_difficulty ? String(subscription.cancellation_difficulty) : '',
        tags: Array.isArray(subscription.tags) ? subscription.tags.join(', ') : '',
    ...
    return (
        <AppLayout>
            ...
            <PageHeader title={`Edit ${subscription.service_name}`} description="Update subscription details">
                <Button variant="outline" asChild>
                    <Link href={`/subscriptions/${subscription.id}`}>Back to Details</Link>
                </Button>
            </PageHeader>
