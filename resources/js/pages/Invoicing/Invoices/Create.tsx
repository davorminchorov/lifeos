...
import type { Customer, TaxRate } from '@/types/models'
...
export default function InvoiceCreate({ customers, taxRates = [], selectedCustomerId }: InvoiceCreateProps) {
    ...
    return (
        <AppLayout>
            ...
            <PageHeader title="Create Invoice" description="Create a new draft invoice">
                <Button variant="outline" asChild>
                    <Link href="/invoicing/invoices">Back to List</Link>
                </Button>
            </PageHeader>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Add items to this invoice</p>
                                </div>
