        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-card rounded-lg shadow-sm border p-6">
              ...
              <p className="text-muted-foreground mb-4">Manage your recurring subscriptions</p>
            ...
            <div className="bg-card rounded-lg shadow-sm border p-6">
              ...
              <p className="text-muted-foreground mb-4">Track your recurring bills and payments</p>
            ...
            <div className="bg-card rounded-lg shadow-sm border p-6">
              ...
              <p className="text-muted-foreground mb-4">Monitor your investment portfolio</p>
            ...
            <div className="bg-card rounded-lg shadow-sm border p-6">
              ...
              <p className="text-muted-foreground mb-4">Track your job application status</p>
            ...
            <div className="bg-card rounded-lg shadow-sm border p-6">
              ...
              <p className="text-muted-foreground mb-4">Monitor your spending habits</p>
