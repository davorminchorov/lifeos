...
export default function UnifiedLayout({}: UnifiedLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-on-background">
      {/* App Bar - Material Design 3 Top App Bar */}
      <header className="bg-surface text-on-surface shadow-elevation-1 z-30 relative">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          {/* Left section with menu button and title */}
          <div className="flex items-center">
            {/* Mobile menu button */}
            <button
              className="md:hidden mr-2 p-2 rounded-full hover:bg-surface-variant"
            ...
            {/* App title */}
            <Link to="/dashboard" className="text-title-large font-brand">
              LifeOS
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-1">
            ...
            <button className="p-2 rounded-full hover:bg-surface-variant" aria-label="Notifications">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Account menu button */}
            <button className="p-2 rounded-full hover:bg-surface-variant" aria-label="Account menu">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button
              className="hidden md:flex items-center ml-2 px-4 py-2 rounded-full bg-primary text-on-primary hover:shadow-elevation-2"
      ...
      <div className="flex flex-1">
        {/* Sidebar - Material Design 3 Navigation Rail/Drawer */}
        <aside className="hidden md:block w-72 bg-surface shadow-elevation-1">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <aside className="md:hidden fixed left-0 top-0 h-full w-80 bg-surface shadow-elevation-3 z-50 overflow-y-auto">
              {/* Drawer header */}
              <div className="h-16 px-4 flex items-center justify-between border-b border-outline border-opacity-20">
                <span className="text-title-large font-brand">LifeOS</span>
                <button
                  className="p-2 rounded-full hover:bg-surface-variant"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
